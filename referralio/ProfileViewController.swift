...
class ProfileViewController: UIViewController, AppButtonDelegate, UITextFieldDelegate {
  ...
  override func viewDidLoad() {
    ...
    let profileFields = ConstrainedViews(views: profileViews, formats: [
      "H:|-0-[firstNameLabel]-(>=\(padHalf))-[\(firstName)(>=160)]-0-|",
      "H:|-0-[lastNameLabel]-(>=\(padHalf))-[\(lastName)(>=160)]-0-|",
      "H:|-0-[\(updatePhotoLabel)(\(profileSize * 0.6))]-(>=\(padHalf))-[updatePhoto(>=160)]-0-|",
      "H:|-0-[currentAffiliationLabel]-(>=\(padHalf))-[\(currentAffiliation)(>=160)]-0-|",
      "H:|-0-[currentTitleLabel]-(>=\(padHalf))-[\(currentTitle)(>=160)]-0-|",
      "H:|-0-[currentLocationLabel]-(>=\(padHalf))-[\(currentLocation)(>=160)]-0-|",
      "H:|-0-[willingToRelocateLabel]-(>=\(padHalf))-[\(willingToRelocate)(>=160)]-0-|",
      "H:|-0-[minCashComensationLabel]-(>=\(padHalf))-[\(minCashComensation)(>=160)]-0-|",
      "H:|-0-[minEquityComensationLabel]-(>=\(padHalf))-[\(minEquityComensation)(>=160)]-0-|",
      "H:|-0-[targetCompanySizeLabel]-(>=\(padHalf))-[\(targetCompanySize)(>=160)]-0-|",
      "H:|-0-[thankYouTipLabel]-(>=\(padHalf))-[\(thankYouTip)(>=160)]-0-|",
      "H:|-0-[dreamCompaniesLabel]-(>=\(padHalf))-[\(dreamCompanies)(>=160)]-0-|",
      "H:|-0-[lookingForLabel]-(>=\(padHalf))-[\(lookingFor)(>=160)]-0-|",
      "H:|-0-[skillsLabel]-(>=\(padHalf))-[\(skills)(>=160)]-0-|",
      "H:|-0-[blogLabel]-(>=\(padHalf))-[\(blog)(>=160)]-0-|",
      "H:|-0-[githubLabel]-(>=\(padHalf))-[\(github)(>=160)]-0-|",
      "H:|-0-[save(72)]-\(padHalf)-[draft(128)]-(>=\(padHalf))-[cancel(80)]-0-|",
      "V:|-\(pad)-[firstNameLabel]-\(padHalf)-[lastNameLabel]-\(padHalf)-[\(updatePhotoLabel)(\(profileSize * 0.6))]-\(bigPad)-[currentAffiliationLabel]-\(padHalf)-[currentTitleLabel]-\(padHalf)-[currentLocationLabel]-\(bigPad)-[willingToRelocateLabel]-\(padHalf)-[minCashComensationLabel]-\(padHalf)-[minEquityComensationLabel]-\(padHalf)-[targetCompanySizeLabel]-\(padHalf)-[thankYouTipLabel]-\(bigPad)-[dreamCompaniesLabel]-\(padHalf)-[lookingForLabel]-\(padHalf)-[skillsLabel]-\(bigPad)-[blogLabel]-\(padHalf)-[githubLabel]-\(bigPad)-[save]-\(padHalf)-|",
      "V:|-(>=\(pad))-[draft]-\(padHalf)-|",
      "V:|-\(pad)-[\(firstName)]-\(padHalf)-[\(lastName)]-\(padHalf)-[updatePhoto(\(profileSize * 0.6))]-\(bigPad)-[\(currentAffiliation)]-\(padHalf)-[\(currentTitle)]-\(padHalf)-[\(currentLocation)]-\(bigPad)-[\(willingToRelocate)]-\(padHalf)-[\(minCashComensation)]-\(padHalf)-[\(minEquityComensation)]-\(padHalf)-[\(targetCompanySize)]-\(padHalf)-[\(thankYouTip)]-\(bigPad)-[\(dreamCompanies)]-\(padHalf)-[\(lookingFor)]-\(padHalf)-[\(skills)]-\(bigPad)-[\(blog)]-\(padHalf)-[\(github)]-\(bigPad)-[cancel]-\(padHalf)-|",
    ])
